...
// This configuration applies to this API route
...
async function generateLLMResponses(questions: any[], evidenceContent: string): Promise<ReportItem[]> {
 ...
 // For now, we'll simulate the LLM responses with consistent mock data
 ...
 for (const question of questions) {
  ...
  // Simulate an API call to LLM with consistent mock data
...
async function mockLLMCall(question: any, evidenceContent: string) {
 ...
 // Always return the first response for consistency
